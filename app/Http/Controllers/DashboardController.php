   ...
   public function index()
    {
        ...
        // Se envía $modalidades a la vista obligatoriamente
        return view('dashboard', compact(
            'avisos', 'totalAlumnos', 'totalDocentes', 'diasSemana', 'dbMetricas', 'aulaGuia', 'esDocenteGuia', 'bloques', 'matrizHorario', 'esquemaActivo', 'modalidades'
        ));
    }
    /**
