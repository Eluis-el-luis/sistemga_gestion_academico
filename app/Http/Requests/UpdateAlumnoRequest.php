...
class UpdateAlumnoRequest extends FormRequest
{
    ...
    {
        return [
            // Fíjate en la regla unique: ignoramos el ID del alumno actual
            'codigo_unico_persona' => 'required|string|max:20|unique:alumno,codigo_unico_persona,' . $this->alumno->id,
