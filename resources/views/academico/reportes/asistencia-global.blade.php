<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-black text-2xl text-[#3d2c1d] leading-tight">Asistencia Global</h2>
    ...
    <div class="pb-12 pt-6 max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <div class="bg-white rounded-3xl shadow-sm border border-slate-200 p-6">
            @include('academico.reportes.partials.filtros-asistencia', ['ruta' => 'academico.reportes.asistencia-global', 'soloFecha' => true])
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-slate-200 text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        @empty
                            <tr><td colspan="8" class="px-6 py-12 text-center text-stone-500 font-bold">No hay datos de asistencia.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
