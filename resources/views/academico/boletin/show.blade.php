    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 print-hidden">
            ...
            <div class="flex gap-3 w-full sm:w-auto">
                ...
                <a href="{{ route('academico.boletines.constancia', $matricula->id) }}" class="text-[#3d2c1d] hover:text-[#e6ac27] font-bold text-sm flex items-center gap-1 bg-white px-4 py-2 rounded-xl border border-slate-200 shadow-sm transition-colors">
